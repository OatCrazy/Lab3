...
let w = arr[s];
console.log(w +' ' + 'w');
let img1 = 'My_Imag/What_is_Pokemon/Use/WISP_' + arr[s] + '.png';
document.querySelector('img.img1').setAttribute('src', img1);


for (let i = 0; i < 3; i++) {
    if (i === 0) {
        let Choose_1 = 'My_Imag/What_is_Pokemon/Use/Choose_' + arr[i] + '.png';
        document.querySelector('img.Choose_1').setAttribute('src', Choose_1);
        n1 = arr[i];
        console.log(n1 + ' ' + 'n1')
    } else if (i === 1) {
        let Choose_2 = 'My_Imag/What_is_Pokemon/Use/Choose_' + arr[i] + '.png';
        document.querySelector('img.Choose_2').setAttribute('src', Choose_2);
        n2 = arr[i];
        console.log(n2 + ' ' + 'n2')
    } else if (i === 2) {
        let Choose_3 = 'My_Imag/What_is_Pokemon/Use/Choose_' + arr[i] + '.png';
